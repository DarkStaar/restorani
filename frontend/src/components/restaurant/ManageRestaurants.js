...
import { fetchOwnedRestaurants, deleteRestaurant } from "../../services";
...
export default function ManageRestaurants({ history }) {
  ...
  async function fetchData() {
    try {
      const data = await fetchOwnedRestaurants({ page, perPage, search });
  ...
  const onClickRestaurant = (restaurantId) => {
    history.push(`/manage/restaurants/${restaurantId}/meals`);
  }
              ...
              >
                ...
                <td>
                  ...
                  <Link
                    ...
                    to={`/manage/restaurants/${restaurant.id}/edit`}
            ...
            <div className="card-header">
              ...
              <div className="clearfix pt-3">
                <div className="bs-bars float-right">
                  <div id="toolbar">
                    <Link className="btn btn-success" to="/manage/restaurants/new" >
                      Add new restaurant
                    </Link>
                  </div>
                </div>
